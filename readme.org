...
* What's new?
** v0.3
I've added footnote functionality that applies to =[fn::Anonymous footnotes]= and =[cite:@bradmontPageView2025 p. 1;org-cite footnotes]=.
...
=org-inline-fn-overlay-face= styles footnotes.
...
* Configuration  
Using olivetti-mode, =olivetti-body-width= determines the character width of the page; =page-view-lines-per-page= determines the size of a page.
